    ...
    <nav className="flex justify-between items-center p-6 border-b border-gray-200 h-20">
      ...
      <ul className="flex space-x-14 list-none m-0 p-0 text-gray-800 font-bold no-underline hover:text-gray-600 text-xl">
        <li>
          <NavLink
            to="/"
            className={({ isActive }) => (isActive ? "text-custom-orange" : "")}
          >
            Home
          </NavLink>
        </li>
      ...
      <div className="flex items-center relative">
        ...
        <input
          ...
          type="text"
          placeholder="Search"
          className="w-lg pl-12 pr-4 py-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-custom-orange text-lg disabled:bg-gray-200 disabled:text-gray-500 disabled:border-gray-300"
        />
      </div>
